...
CONNECTOR_KINDS = {
    ...
    "web_form": {"label": "Website form", "mode": "api", "icon": "google-forms",
                 "feeds": "Form submissions",
                 "how": "Point your form at the workspace's webhook."},
    "sms": {"label": "Text messages", "mode": "api", "icon": "messages",
            "feeds": "Texts to your business number",
            "how": "Connects a text-enabled number."},
    "voicemail": {"label": "Phone and voicemail", "mode": "upload", "icon": "phone-app",
    ...
    "email": {"label": "Email inbox", "mode": "email_forward", "icon": "gmail",
              "feeds": "Any email",
    ...
    "referral": {"label": "Referrals", "mode": "manual", "icon": "referral-app",
